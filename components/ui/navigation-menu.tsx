...
/*
 * NOTE: the registry ships this component with Base UI state selectors
 * (`data-open`, `data-closed`, `data-popup-open`), but it imports the *Radix*
 * primitives, which emit `data-state="open" | "closed"` instead. Those selectors
 * were dead on arrival — the caret never rotated and the viewport never ran its
 * enter/exit animation. They are rewritten to `data-[state=…]` throughout.
 */
